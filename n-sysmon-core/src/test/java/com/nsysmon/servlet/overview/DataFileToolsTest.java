...
public class DataFileToolsTest {
    ...
    @Test public void getNsysmonControllerIdFromFilename(){
        String fileName = "Part1Part/nsysmon_Part2Part_2016-03-09T19:01:55.178";
        String id = new DataFileTools().getNsysmonControllerIdFromFilename(fileName);
        Assert.assertNotNull(id);
        Assert.assertEquals("Part2Part", id);
    }

    @Test public void getNsysmonControllerIdFromFilename2(){
        String fileName = "nsysmon_overviewDebuggingData_2016-03-09T20_58_03.173";
        String id = new DataFileTools().getNsysmonControllerIdFromFilename(fileName);
        Assert.assertNotNull(id);
    ...
    @Test public void toFilename(){
        ...
        String fileName = new DataFileTools().toFilename(outputPath, pageDef, fileDate);
