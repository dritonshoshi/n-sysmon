 ...
 * @author arno
 */
public class NSysMonCallableStatement extends NSysMonPreparedStatement implements CallableStatement {
    private final CallableStatement inner;

    public NSysMonCallableStatement(Connection conn, CallableStatement inner, NSysMonApi sysMon, String sql) {
