 ...
 * @author arno
 */
public class NSysMonPreparedStatement extends NSysMonStatement implements PreparedStatement {
    ...
    public NSysMonPreparedStatement(Connection conn, PreparedStatement inner, NSysMonApi sysMon, String sql) {
