 ...
 * @author arno
 */
public class NSysMonConnection implements Connection {
    ...
    public NSysMonConnection(Connection inner, NSysMonApi sysMon, String poolIdentifier, AIConnectionCounter connectionCounter) {
        this.inner = inner;
        this.sysMon = sysMon;
...
//------------------- Wrapper interface
    ...
    public void commit() throws SQLException {
        makePassive();
        final ASimpleMeasurement m = sysMon.start(NSysMonStatement.IDENT_PREFIX_JDBC + "commit");
        try {
            inner.commit();
        }
        finally {
    ...
    public void rollback() throws SQLException {
        makePassive();
        final ASimpleMeasurement m = sysMon.start(NSysMonStatement.IDENT_PREFIX_JDBC + "rollback");
        try {
            inner.rollback();
        } finally {
            m.finish();
    ...
    public Savepoint setSavepoint() throws SQLException {
        final ASimpleMeasurement m = sysMon.start(NSysMonStatement.IDENT_PREFIX_JDBC + "setSavepoint");
        try {
    ...
    public void releaseSavepoint(Savepoint savepoint) throws SQLException {
        final ASimpleMeasurement m = sysMon.start(NSysMonStatement.IDENT_PREFIX_JDBC + "releaseSavepoint");
        try {
