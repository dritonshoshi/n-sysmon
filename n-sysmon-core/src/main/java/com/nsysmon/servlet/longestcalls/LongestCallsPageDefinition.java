...
public class LongestCallsPageDefinition extends AAbstractNsysmonPerformancePageDef {
    private final LongestCallsDataSink collector;
    ...
    public LongestCallsPageDefinition(int bufferSize, boolean initialStarted, String findRegEx, String entriesToIgnoreAsString) {
        ...
        this.collector = new LongestCallsDataSink(bufferSize, initialStarted, findRegEx, entriesToIgnore);
    }
    ...
    private String getTitle() {
        return "Top " + bufferSize + " Longest Calls " + (this.filterData ? "matching '" + this.findRegEx + "'" : "");
    }
